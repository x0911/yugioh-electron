...
function findCardByName(name: string): WhitelistCard | undefined {
...
function findCardId(nameOrId: string | number): number {
...
function writeYdkFile(filepath: string, mainCards: number[], extraCards: number[]): void {
...
// -----------------------------------------------------------------------------
// Character Roster Definition (10 DM + 10 GX)
// -----------------------------------------------------------------------------

interface RawCharacterDef {
  id: string;
  name: string;
  series: 'DM' | 'GX';
  title: string;
  ...
  decks: {
    ...
    extraCards?: (string | number)[];
  }[];
}

const CHARACTERS: RawCharacterDef[] = [
  // ===========================================================================
  ...
  // ===========================================================================
  {
    ...
    description:
      'A kind-hearted high school student who solved the ancient Millennium Puzzle. Yugi trusts completely in the Heart of the Cards and uses clever defensive and toolbox combos.',
    themeColor: '#9b51e0',
    decks: [
      {
        id: 'yugi_deck_1',
  ...
  },
  {
    ...
    description:
      'The spirit of Pharaoh Atem residing within the Millennium Puzzle. Commands the ultimate Spellcaster monsters, the legendary Egyptian Gods, and heroic ritual warriors.',
    themeColor: '#7b1fa2',
    decks: [
      {
        id: 'yami_deck_1',
  ...
  },
  {
    ...
    description:
      'The billionaire head of Kaiba Corporation and creator of Duel Disks. Relies on overwhelming dragon beatdown power and high-tech destructive strategies.',
    themeColor: '#2f80ed',
    decks: [
      {
        id: 'kaiba_deck_1',
  ...
  },
  {
    ...
    description:
      'A fiercely loyal duelist who relies on guts, raw determination, warrior instincts, and high-risk luck cards that turn the tide in an instant.',
    themeColor: '#f2994a',
    decks: [
      {
        id: 'joey_deck_1',
  ...
  },
  {
    ...
    description:
      'Yugi’s closest friend whose deck focuses on radiant fairy monsters, continuous Life Point recovery, and peaceful stalling spells.',
    themeColor: '#56ccf2',
    decks: [
      {
        id: 'tea_deck_1',
  ...
  },
  {
    ...
    description:
      'A tough and reliable ally who commands military machines, tactical commanders, and steadfast earth warriors.',
    themeColor: '#27ae60',
    decks: [
      {
        id: 'tristan_deck_1',
  ...
  },
  {
    ...
    description:
      'A glamorous and independent master duelist whose Harpie Lady flock controls the field with swift aerial strikes.',
    themeColor: '#e91e63',
    decks: [
      {
        id: 'mai_deck_1',
  ...
  },
  {
    ...
    description:
      'Possessed by the sinister spirit of the Millennium Ring, Bakura uses terrifying fiends, occult destiny boards, and deck destruction.',
    themeColor: '#673ab7',
    decks: [
      {
        id: 'bakura_deck_1',
  ...
  },
  {
    ...
    description:
      'Leader of the Rare Hunters and wielder of the Millennium Rod. Binds his victims with sadistic burn damage and the golden sun god.',
    themeColor: '#ffc107',
    decks: [
      {
        id: 'marik_deck_1',
  ...
  },
  {
    ...
    description:
      'The flamboyant president of Industrial Illusions and creator of the card game. Bypasses defenses with whimsical cartoon Toons and eldritch illusions.',
    themeColor: '#9c27b0',
    decks: [
      {
        id: 'pegasus_deck_1',
  ...
  // ===========================================================================
  {
    ...
    description:
      'The carefree hero of Duel Academy who loves the thrill of dueling. Fuses Elemental HEROes and contacts Neo-Spacians with boundless enthusiasm.',
    themeColor: '#eb5757',
    decks: [
      {
        id: 'jaden_deck_1',
  ...
  },
  {
    ...
    description:
      'The top student at Duel Academy who masters Cyber Dragon fusions before descending into the underworld of Cyberdark dragons.',
    themeColor: '#00bcd4',
    decks: [
      {
        id: 'zane_deck_1',
  ...
  },
  {
    ...
    description:
      'Zane’s younger brother who overcomes self-doubt through the power of cheerful and quirky Vehicroid machines.',
    themeColor: '#2196f3',
    decks: [
      {
        id: 'syrus_deck_1',
  ...
  },
  {
    ...
    description:
      'The proud elite duelist who survived North Academy. Master of Armed Dragon evolutions, Ojama trios, and V-to-Z machine fusions.',
    themeColor: '#ff9800',
    decks: [
      {
        id: 'chazz_deck_1',
  ...
  },
  {
    ...
    description:
      'The top female duelist at Duel Academy. Combines graceful Cyber martial artist warriors with deadly ice and ballerina fusions.',
    themeColor: '#3f51b5',
    decks: [
      {
        id: 'alexis_deck_1',
  ...
  },
  {
    ...
    description:
      'A brilliant student who calculated six distinct element decks. Uses chemical bonding reactions to summon the colossal Water Dragon.',
    themeColor: '#4caf50',
    decks: [
      {
        id: 'bastion_deck_1',
  ...
  },
  {
    ...
    description:
      'A relaxed and creative duelist from Australia who loves grilled cheese and gentle Australian wildlife before becoming an Industrial Illusions card designer.',
    themeColor: '#8d6e63',
    decks: [
      {
        id: 'chumley_deck_1',
  ...
  },
  {
    ...
    description:
      'The genius pro league duelist who wields the dark mirror to Elemental HEROes: the philosophical and merciless Destiny HEROes.',
    themeColor: '#607d8b',
    decks: [
      {
        id: 'aster_deck_1',
  ...
  },
  {
    ...
    description:
      'A warm-hearted transfer student from North Academy who speaks to the spirits of his seven Crystal Beasts and summons Rainbow Dragon.',
    themeColor: '#00e676',
    decks: [
      {
        id: 'jesse_deck_1',
  ...
  },
  {
    ...
    description:
      'The flamboyant yet formidable professor at Duel Academy who possesses a PhD in Dueling and commands unstoppable Ancient Gear siege engines.',
    themeColor: '#c0ca33',
    decks: [
      {
        id: 'crowler_deck_1',
...
const finalCharacters: CharacterData[] = [];
...
for (const charDef of CHARACTERS) {
  ...
  const builtDecks: CharacterDeckData[] = [];
  const allCharSignatureCards: number[] = [];
