...
export const useSettingsStore = defineStore('settings', {
    ...
    getters: {
        ...
        selectedCharacterDecks(state) {
            const char = state.characters.find((c) => c.id === state.selectedOpponentId) || state.characters[0];
    ...
    actions: {
        ...
        async setSelectedOpponent(id) {
            this.selectedOpponentId = id;
            await this.persist();
        },
        async setSelectedSeriesFilter(filter) {
