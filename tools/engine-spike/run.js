import createCore, { OcgDuelMode, OcgProcessResult, OcgLocation, OcgPosition, OcgMessageType, ocgMessageTypeStrings, ocgPhaseString, } from 'ocgcore-wasm';
        ...
        for (const msg of messages) {
            switch (msg.type) {
                ...
                case OcgMessageType.BATTLE: {
                    ...
                    console.log(`  [BATTLE] Attacker (ATK ${msg.card.attack}) vs Defender (ATK ${defenderAtk})`);
                ...
                case OcgMessageType.DAMAGE: {
                    ...
                    if (msg.player === 0)
                        p0LP = Math.max(0, p0LP - msg.amount);
                    if (msg.player === 1)
                        p1LP = Math.max(0, p1LP - msg.amount);
                    break;
                }
